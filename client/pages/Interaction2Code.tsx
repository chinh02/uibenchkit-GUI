      ...
      <div className="ml-64 pt-24 sm:pt-28 pb-12">
        <main className="max-w-[1000px] mx-auto px-6 lg:px-8">
          <div className="flex flex-col gap-6 sm:gap-8">
            <div className="mb-4">
              <h1 className="text-4xl font-bold text-text-primary mb-4">Interaction2Code</h1>
            ...
            <div className="flex flex-col rounded-xl border border-amber-200/50 bg-card shadow-sm">
              <div className="flex flex-col gap-2 p-4 sm:p-6 border-b border-amber-200/50 bg-gradient-to-r from-amber-100/50 to-amber-50/30">
              ...
              <div className="flex flex-col gap-6 p-4 sm:p-8">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <div className="flex w-10 h-10 items-center justify-center rounded-full border-2 border-amber-300 bg-amber-100 flex-shrink-0">
                    <span className="text-amber-700 font-bold text-lg leading-7">
                      1
                    </span>
                  </div>
