          ...
          <div className="flex flex-col gap-6 sm:gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 p-4 sm:p-6 rounded-xl border border-[#E9D4FF] bg-[rgba(173,70,255,0.05)]">
              ...
              <div className="flex flex-col gap-1 flex-1">
                ...
                <div className="text-text-secondary text-sm sm:text-base leading-relaxed sm:leading-[26px]">
                  ...
                  <strong>Dataset.</strong> The sample of our experiment data is available in /sample. We will release the full dataset as soon as the paper is published.<br />
                  <strong>Codes.</strong> The code is available in /code, including the interactive webpage generation, metric calculation and annotation.<br />
                  <strong>Human evaluation results.</strong> The results of human evaluation are in /huamn_evalauation. We will release the full human evaluation results as soon as the paper is published.<br />
            ...
            <div className="flex flex-col rounded-xl border border-[#E2E8F0] bg-white/80 shadow-sm">
              <div className="flex flex-col gap-2 p-4 sm:p-6 border-b border-[#E2E8F0] bg-gradient-to-r from-[rgba(97,95,255,0.1)] to-[rgba(173,70,255,0.1)]">
                <div className="flex items-center gap-3">
                  <Package className="w-6 h-6 sm:w-7 sm:h-7 text-[#4F39F6]" strokeWidth={2.33} />
                  ...
                  <div className="flex flex-col gap-2 flex-1 w-full">
                    ...
                    <div className="flex flex-col gap-2 p-4 sm:p-5 rounded-lg border border-[#E2E8F0] bg-[#F1F5F9] font-mono overflow-x-auto">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 ml-4">
                        ...
                        <span className="text-[#314158] text-xs sm:text-sm">Using ui-ux-pro-max skill, create a landing page for my coffee shop</span>
                      </div>
                    </div>
            ...
            <div className="flex flex-col rounded-2xl border border-[#E2E8F0] bg-white/80 shadow-sm" id="leaderboard">
              <div className="flex flex-col gap-2 p-4 sm:p-6 border-b border-[#E2E8F0] bg-gradient-to-r from-[rgba(0,184,219,0.1)] to-[rgba(43,127,255,0.1)]">
                <div className="flex items-center gap-3">
                  <Code className="w-6 h-6 sm:w-7 sm:h-7 text-[#0092B8]" strokeWidth={2.33} />
              ...
              <div className="p-2 sm:p-4 overflow-x-auto">
                <div className="rounded-lg bg-white overflow-hidden min-w-[800px]">
                  <div className="flex items-center justify-between px-4 py-2.5 rounded-md bg-[#0092B8] text-white">
                    <div className="w-20 sm:w-28 font-bold text-xs sm:text-sm">Rank</div>
                    <div className="w-48 sm:w-60 font-semibold text-xs sm:text-sm">Model</div>
                    <div className="w-20 sm:w-24 font-semibold text-xs sm:text-sm">Clip</div>
                    <div className="w-20 sm:w-24 font-semibold text-xs sm:text-sm">SSIM</div>
                    <div className="w-20 sm:w-24 font-semibold text-xs sm:text-sm">Text</div>
                    <div className="w-20 sm:w-24 font-semibold text-xs sm:text-sm">Position</div>
                    <div className="w-20 sm:w-28 font-semibold text-xs sm:text-sm">IR</div>
                    <div className="w-20 sm:w-24 font-semibold text-xs sm:text-sm">Overall</div>
                  </div>
                  {leaderboardData.map((row, index) => (
                    <div key={index}>
                      <div className={`flex items-center justify-between px-4 py-3 sm:py-4 ${index % 2 === 0 ? 'bg-bg-soft' : ''}`}>
                        <div className="w-20 sm:w-28 text-[#363636] font-medium text-xs sm:text-sm">#{row.rank}</div>
                        <div className="w-48 sm:w-60 text-[#363636] font-medium text-xs sm:text-sm truncate">{row.model}</div>
                        <div className="w-20 sm:w-24 text-[#363636] font-medium text-xs sm:text-sm">{row.clip}</div>
                        <div className="w-20 sm:w-24 text-[#363636] font-medium text-xs sm:text-sm">{row.ssim}</div>
                        <div className="w-20 sm:w-24 text-[#363636] font-medium text-xs sm:text-sm">{row.text}</div>
                        <div className="w-20 sm:w-24 text-[#363636] font-medium text-xs sm:text-sm">{row.position}</div>
                        <div className="w-20 sm:w-28 text-[#363636] font-medium text-xs sm:text-sm">{row.ir}</div>
                        <div className="w-20 sm:w-24 text-blue-primary font-semibold text-xs sm:text-sm">{row.overall}</div>
                      </div>
            ...
            <div className="flex flex-col rounded-xl border border-[#FEE685] bg-white/80 shadow-sm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 sm:p-6 bg-gradient-to-r from-[rgba(254,154,0,0.1)] to-[rgba(255,105,0,0.1)]">
                ...
                >
                  <span className="text-[#E17100] font-bold text-sm sm:text-base leading-6">View CCS Guide</span>
            ...
            <div className="flex flex-col gap-4 sm:gap-6 p-4 sm:p-8 rounded-2xl border border-[#E2E8F0] bg-white/80 shadow-sm">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="flex p-2 sm:p-3 rounded-xl bg-[#DBEAFE]">
                  <Lightbulb className="w-5 h-5 sm:w-6 sm:h-6 text-blue-primary" strokeWidth={2} />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg border border-[#E2E8F0] bg-bg-soft">
                  <Code className="w-5 h-5 sm:w-6 sm:h-6 text-green-teal flex-shrink-0 mt-0.5" strokeWidth={2} />
                ...
                <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg border border-[#E2E8F0] bg-bg-soft">
                  <MessageSquare className="w-5 h-5 sm:w-6 sm:h-6 text-blue-cyan flex-shrink-0 mt-0.5" strokeWidth={2} />
                  <div className="flex flex-col gap-1">
                ...
                <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg border border-[#E2E8F0] bg-bg-soft">
                  <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-[#2B7FFF] flex-shrink-0 mt-0.5" strokeWidth={2} />
                  <div className="flex flex-col gap-1">
                ...
                <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg border border-[#E2E8F0] bg-bg-soft">
                  <Star className="w-5 h-5 sm:w-6 sm:h-6 text-purple-primary flex-shrink-0 mt-0.5" strokeWidth={2} />
                  <div className="flex flex-col gap-1">
