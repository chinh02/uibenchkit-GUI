...
export default function Header() {
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <div className="w-full max-w-[1024px] flex items-center px-6 py-3 rounded-full border border-white/40 bg-white/70 shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_25px_50px_-12px_rgba(0,0,0,0.05)] backdrop-blur-xl">
        <div className="flex items-center justify-between flex-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <a 
              href="#paper" 
              className="flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-[#2563EB] to-[#06B6D4] shadow-[0_10px_15px_-3px_rgba(43,127,255,0.2),0_4px_6px_-4px_rgba(43,127,255,0.2)]"
            >
              <span className="text-white font-bold text-xs leading-4">
                More in the paper !
              </span>
